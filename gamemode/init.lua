...
GM.RoundTimeOverride = CreateConVar("ph_roundtime_override", -1, bit.bor(FCVAR_NOTIFY), "Fixed time (in seconds) to set the round to. Use -1 to autocalculate")
...
GM.HideTimer = CreateConVar("ph_props_hidetimer", 30, bit.bor(FCVAR_NOTIFY, FCVAR_REPLICATED), "How many seconds the props have to hide" )
...
GM.RandomTeams = CreateConVar("ph_teams_random", 1, bit.bor(FCVAR_NOTIFY), "Randomizes the teams each round instead of just swapping them")
